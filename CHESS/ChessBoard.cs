    ...
    public class ChessBoard
    {
        ...
        private Case[,] InitBoard()
        {
            Case[,] board = new Case[,]
            {
                ...
                { new Case(new Rook(Color.Black),3, 0), new Case(new EmptyPiece(),3, 1), new Case(new EmptyPiece(),3, 2),new Case(new EmptyPiece(),3, 3), new Case(new EmptyPiece(),3, 4), new Case(new EmptyPiece(),3, 5), new Case(new EmptyPiece(),3, 6), new Case(new EmptyPiece(),3, 7) },
